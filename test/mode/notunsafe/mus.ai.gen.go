...
func (s fullStructMUS) Marshal(v mode.FullStruct, bs []byte) (n int) {
	...
	n += mapuQNcWTkkhDD2E1YGlud1YgΞΞ.Marshal(v.MapStrInt, bs[n:])
...
func (s fullStructMUS) Unmarshal(bs []byte) (v mode.FullStruct, n int, err error) {
	...
	v.MapStrInt, n1, err = mapuQNcWTkkhDD2E1YGlud1YgΞΞ.Unmarshal(bs[n:])
	n += n1
	if err != nil {
		return
	}
...
func (s fullStructMUS) Skip(bs []byte) (n int, err error) {
	...
	n1, err = mapuQNcWTkkhDD2E1YGlud1YgΞΞ.Skip(bs[n:])
	n += n1
	if err != nil {
		return
	}
